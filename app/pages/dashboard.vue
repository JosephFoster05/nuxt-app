...
<template>
  ...
  <div>
    ...
    <button class="delete-data" @click="openRequestDelete"> Request deletion of data </button>
  </div>
  ...
  <div v-if="showRequestDelete" class="modal-overlay">
    <div class="modal">
      ...
      <p>This will permanently delete your account and associated data. Enter your password to confirm.</p>
      <label>
        Password
        <input type="password" v-model="requestPassword" :disabled="requestDeleting" />
      </label>
